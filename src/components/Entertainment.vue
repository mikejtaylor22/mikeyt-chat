<template>
     <div class="chat container">
        <h2 class="center red-text">&reg;Chat by MikeyT</h2>
        <h5 class="center red-text">Entertainment Room</h5>
        <div class="card">
        ...
        <div class="online">
            ...
            <span class="red-text smalluser">{{this.name}}</span>
            </div>
            <div class="rooms">
...
export default {
  ...
  created(){
    let ref = db.collection('ent-messages').orderBy('timestamp')
